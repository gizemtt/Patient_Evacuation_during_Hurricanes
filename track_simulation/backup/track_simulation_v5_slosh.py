...
def track_simulator(_landfall_track, _numScenario, _output_location, _reference):
   ...
   # Yr 2017 2/3 probability circle
    ...
    reference_direction = {'current-0': index_landfall, 'landfall-1': 1, 'landfall-2': 2, 'landfall-3': 3}
    reference_time = _landfall_track['time'][index_landfall - reference_direction[_reference]]
    print("reference time : ", landfall_time, " ", reference_time)
...
if __name__ == "__main__":
    ...
    list_landfall = [0, 0, 0, 0, 0, 1, 1, 1]  # manual input of landfall status
    reference = 'landfall-1'  # {'current-0': index_landfall, 'landfall-1': 1, 'landfall-2': 2, 'landfall-3': 3}
